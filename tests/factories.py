        ...
        api_models.Study(
            ...
            assays={
                ...
                api_models.Assay(
                    ...
                    technology_type=api_models.OntologyTermRef(name="nucleotide sequencing", accession="http://purl.obolibrary.org/obo/OBI_0000626", ontology_name="OBI"),
                    measurement_type=api_models.OntologyTermRef(name="exome sequencing", accession=None, ontology_name=None), comments={}
                    ),
                ...
                api_models.Assay(
                    ...
                    technology_platform="Illumina", technology_type=api_models.OntologyTermRef(name="nucleotide sequencing", accession="http://purl.obolibrary.org/obo/OBI_0000626", ontology_name="OBI"),
                    measurement_type=api_models.OntologyTermRef(name="exome sequencing", accession=None, ontology_name=None), comments={}
                    )
                }
            )
