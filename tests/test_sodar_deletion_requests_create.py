...
def test_sodar_deletion_requests_gather_deletion_request_paths(fake_irods_objs, del_req_args):
    ...
    assert ["/irods/project-assay/basecol1/file.txt"] == get_actual(
    ...
    assert [
        "/irods/project-assay/basecol1/subcol2/file1.idx",
        "/irods/project-assay/basecol2/subcol2/file1.idx",
    ] == get_actual(["*/*/*.idx"])
    # Only expand direct (folder) matches, not recursively the files also
    assert [
        "/irods/project-assay/basecol1/subcol",
        "/irods/project-assay/basecol2/subcol",
    ] == get_actual(["*/subcol"])
    ...
    assert [
        "/irods/project-assay/basecol1/file.txt",
        "/irods/project-assay/basecol1/subcol/file1.txt",
    ] == get_actual(["basecol1/file.txt", "basecol1/subcol/file1.txt"])
    # with '*' expansion
    assert [
        "/irods/project-assay/basecol1/file.txt",
        "/irods/project-assay/basecol1/subcol2/file1.txt",
...
def test_sodar_deletion_requests_smoke_test(mockapi, fake_irods_objs):
    ...
    mockapi_obj.get_assay_from_uuid = MagicMock(
        return_value=(MagicMock(irods_path="/irods/project-assay"), "study")
    )
