...
from cubi_sak.snappy.itransfer_raw_data import run as run_itransfer_raw_data
...
def test_run_snappy_itransfer_raw_data_smoke_test(mocker):
    ...
    mocker.patch("cubi_sak.snappy.itransfer_raw_data.check_output", mock_check_output)

    # Actually exercise code and perform test.
    parser, subparsers = setup_argparse()
    args = parser.parse_args(argv)
    res = run_itransfer_raw_data(args, parser, subparsers)
