"""``cubi-sak snappy itransfer-variant-calling``: transfer variant_calling results into iRODS landing zone."""
...
def setup_argparse(parser: argparse.ArgumentParser) -> None:
    """Setup argument parser for ``cubi-sak snappy itransfer-variant-calling``."""
