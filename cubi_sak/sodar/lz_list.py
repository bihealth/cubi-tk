"""``cubi-sak sodar landing-zone-list`` command line program
"""
...
class ListLandingZoneCommand:
    ...
    def execute(self) -> typing.Optional[int]:
        ...
        logger.info("Starting cubi-sak sodar landing-zone-list")
...
def setup_argparse(parser: argparse.ArgumentParser) -> None:
    """Setup argument parser for ``cubi-sak sodar landing-zone-list``."""
