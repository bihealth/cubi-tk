"""``cubi-sak sea-snap pull-isa``: pull ISA files from SODAR.

More Information
----------------

- Also see ``cubi-sak sea-snap`` :ref:`cli_main <CLI documentation>` and ``cubi-sak sea-snap pull-isa --help`` for more information.
